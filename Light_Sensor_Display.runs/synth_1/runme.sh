...
HD_PWD='/home/moafk/Documents/FPGA/Kria_Projects/Light_Sensor_Display/Light_Sensor_Display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ambient_light_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ambient_light_display.tcl
